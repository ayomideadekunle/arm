              ...
              foreach ($contracts as $contract) {
                ...
                <tr>
                  ...
                  foreach ($tenant_infos as $tenant) {
                    ?>
                    <td><?php
                    echo $tenant['firstname']; echo ' '; echo $tenant['lastname'];
                    ?></td>
                  <?php }?>
                  <?php
                ...
                <td>
                  ...
                  <?php if($contract["isnotified"] == 1){ ?>
                  <button onclick="notifyTenant('<?php echo $contract['id']; ?>');" class="btn btn-primary btn-sm notify hidden" userid="<?php echo $contract["tenant_id"]?>"><i class="fa fa-send"></i></button>
                <?php } else { ?>
                  <button onclick="notifyTenant('<?php echo $contract['id']; ?>');" class="btn btn-primary btn-sm notify" userid="<?php echo $contract["tenant_id"]?>"><i class="fa fa-send"></i></button>
                <?php }?>
